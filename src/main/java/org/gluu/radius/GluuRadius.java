...
public class GluuRadius {

	private static final Logger logger = Logger.getLogger(GluuRadius.class);
	private static final String WAIT_TIMEOUT_PROPERTY_NAME = "radius.wait_timeout";
	private static final String RETRYCOUNT_PROPERTY_NAME = "radius.retrycount";
	...
	public static void main(String [] args) {
		...
		logger.info("Gluu Radius running.");
